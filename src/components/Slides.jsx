...
export const Slide1 = () => (
  <HeroSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/hero-bg.png`}
    overlayOpacity={0.5}
  />
);
...
export const Slide2 = () => (
  <DataSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/ewaste_circuit.jpg`}
    dataItems={[
...
export const Slide6 = () => (
  <HeroSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/real_seelampur.jpg`}
  />
);
...
export const Slide7 = () => (
  <SplitSlide
    ...
    image={`${import.meta.env.BASE_URL}assets/real_seelampur.jpg`}
    bodyParagraphs={[
...
export const Slide8 = () => (
  <DataSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/seelampur.png`}
    dataItems={[
...
export const Slide10 = () => (
  <HeroSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/real_moradabad.jpg`}
  />
);
...
export const Slide11 = () => (
  <SplitSlide
    ...
    image={`${import.meta.env.BASE_URL}assets/real_moradabad.jpg`}
    imageLeft
    bgAlt
    bodyParagraphs={[
...
export const Slide12 = () => (
  <DataSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/moradabad_river2.jpg`}
    dataItems={[
...
export const Slide14 = () => (
  <HeroSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/real_agbogbloshie.jpg`}
    overlayOpacity={0.5}
  />
);
...
export const Slide15 = () => (
  <SplitSlide
    ...
    image={`${import.meta.env.BASE_URL}assets/agbogbloshie_burning.jpg`}
    bodyParagraphs={[
...
export const Slide16 = () => (
  <DataSlide
    ...
    bgImage={`${import.meta.env.BASE_URL}assets/agbogbloshie_workers.jpg`}
    dataItems={[
